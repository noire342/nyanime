...
object Constants {
    const val URL_HELP = "https://github.com/noire342/nyanime/blob/main/docs/support.md"
    const val URL_HELP_UPCOMING = "https://github.com/noire342/nyanime/blob/main/docs/support.md#uscite-in-arrivo"
