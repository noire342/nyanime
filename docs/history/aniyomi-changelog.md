> Archivio del changelog upstream AniYomi, conservato per provenienza.
> La sezione “Unreleased” qui sotto appartiene all'archivio importato.
> Per le modifiche Nyanime consulta il [changelog corrente](../../CHANGELOG.md).
